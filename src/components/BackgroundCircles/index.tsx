...
export function BackgroundCircles() {
  return (
    <motion.div
      ...
      <div className="absolute border border-gray-700 opacity-20 rounded-full h-[500px] w-[500px] mt-52 " />
      <div className="rounded-full border border-cyan-400 opacity-20 h-[650px] w-[650px] absolute        mt-52  animate-pulse " />
      <div className="absolute border border-gray-700 opacity-20 rounded-full h-[800px] w-[800px] mt-52" />
    </motion.div>
  )
}